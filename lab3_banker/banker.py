...
class Banker:
    ...
    def request_resources(self, customer_index, request):
        ...
        safe = self.check_safe(customer_index, request, available, need, allocation)
    ...
    def check_safe(self, customer_index, request, work, need, allocation):
        ...
        # update work (available), need, allocation for all processes
        ...
        def exist_ok(need, allocation, work):
        ...
        while exist_ok(need, allocation, work):
            continue
